					...
					<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
						<div class="section-heading2" style="text-align: left">
							...
							<div style="width: 50%;float: left ">
								...
								<p>WDC Space is a mobile App based on the Wisdom  Chain, which integrates asset management、asset storage、app on the chain and industry information.</p>
								<div style="width: auto;float:left;text-align:center">
									...
									<p style="">IOS<br><span style="font-size:13px">(Search the WDC Space in AppStore for download)</span></p>
								</div>
				...
				<div class="row">
					<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
						<div class="section-heading2" style="margin-top: 40px;">
							<h2 class="wow  fadeIn animated" data-wow-duration="1.0s" style="visibility: visible; animation-duration: 1.0s; animation-name: fadeIn;">Application</h2>
						</div>
					</div>
				</div>
