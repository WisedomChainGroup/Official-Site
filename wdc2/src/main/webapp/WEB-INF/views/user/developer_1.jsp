			...
			<div class="row">
				<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
					<div class="section-heading2">
						<h2 class="wow  fadeIn animated" data-wow-duration="1.0s" style="visibility: visible; animation-duration: 1.0s; animation-name: fadeIn;">开发者工具</h2>
					</div>
				</div>
			</div>
			<div class="row">
				<div class="blog-slider">
					...
					<div id="developer_1" style="display:none" class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
						<div class="blog wow  fadeIn animated" data-wow-duration="1.3s" style="visibility: visible; animation-duration: 1.3s; animation-name: fadeIn;">
							<figure><a target="_blank" href="https://github.com/WisedomChainGroup"><img id="developer_img_1" src="${APP_PATH}/static/mod/images/mod/28.jpg" alt="" style="height: 212.8px;"/></a></figure>
							<div class="content" style="height: 200px;">
								<center><h4><a id="developer_title_1" href="#">主链GitHub的源码</a></h4>
								<p id="developer_descr_1">主链GitHub的源码</p>
								</center>
							</div>
						</div>
					</div>
					
					<div id="developer_2" style="display:none" class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
						<div class="blog wow  fadeIn animated" data-wow-duration="1.3s" style="visibility: visible; animation-duration: 1.3s; animation-name: fadeIn;">
							<figure><a target="_blank" href="https://github.com/WisedomChainGroup/java-sdk"><img id="developer_img_2" src="${APP_PATH}/static/mod/images/mod/28.jpg" alt="" style="height: 212.8px;"/></a></figure>
							<div class="content" style="height: 200px;">
								<center><h4><a id="developer_title_2" href="#">主链GitHub的源码</a></h4>
								<p id="developer_descr_2">主链GitHub的源码</p>
								</center>
							</div>
						</div>
					</div>
					
					<div id="developer_3" style="display:none" class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
						<div class="blog wow  fadeIn animated" data-wow-duration="1.3s" style="visibility: visible; animation-duration: 1.3s; animation-name: fadeIn;">
							<figure><a target="_blank" href="https://github.com/WisedomChainGroup/objectivec-sdk"> <img id="developer_img_3" src="${APP_PATH}/static/mod/images/mod/28.jpg" alt="" style="height: 212.8px;"/></a></figure>
							<div class="content" style="height: 200px;">
								<center><h4><a id="developer_title_3" href="#">主链GitHub的源码</a></h4>
								<p id="developer_descr_3">主链GitHub的源码</p>
								</center>
							</div>
						</div>
					</div>
					
					<div id="developer_4" style="display:none" class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
						<div class="blog wow  fadeIn animated" data-wow-duration="1.3s" style="visibility: visible; animation-duration: 1.3s; animation-name: fadeIn;">
							<figure><a target="_blank" href="https://github.com/WisedomChainGroup/js-sdk"><img id="developer_img_4" src="${APP_PATH}/static/mod/images/mod/28.jpg" alt="" style="height: 212.8px;"/></a></figure>
							<div class="content" style="height: 200px;">
								<center><h4><a id="developer_title_4" href="#">主链GitHub的源码</a></h4>
								<p id="developer_descr_4">主链GitHub的源码</p>
								</center>
							</div>
						</div>
					</div>
					
					<div id="developer_5" style="display:none" class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
						<div class="blog wow  fadeIn animated" data-wow-duration="1.3s" style="visibility: visible; animation-duration: 1.3s; animation-name: fadeIn;">
							<figure><a target="_blank" href="https://github.com/WisedomChainGroup/php-sdk"><img id="developer_img_5" src="${APP_PATH}/static/mod/images/mod/28.jpg" alt="" style="height: 212.8px;"/></a></figure>
							<div class="content" style="height: 200px;">
								<center><h4><a id="developer_title_5" href="#">主链GitHub的源码</a></h4>
								<p id="developer_descr_5">主链GitHub的源码</p>
								</center>
							</div>
						</div>
					</div>
					...
					<div id="developer_5" style="display:none" class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
							<div class="blog wow  fadeIn animated" data-wow-duration="1.3s" style="visibility: visible; animation-duration: 1.3s; animation-name: fadeIn;">
								<figure><img id="developer_img_5" src="${APP_PATH}/static/mod/images/mod/28.jpg" alt="" style="height: 212.8px;"/></figure>
								<div class="content" style="height: 200px;">
									<center><h4><a id="developer_title_5" href="#">主链GitHub的源码</a></h4>
									<p id="developer_descr_5">主链GitHub的源码</p>
									</center>
					...
					<!--
					<div id="developer_6" style="display:none" class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
						<div class="blog wow  fadeIn animated" data-wow-duration="1.3s" style="visibility: visible; animation-duration: 1.3s; animation-name: fadeIn;">
							<figure><img id="developer_img_6" src="${APP_PATH}/static/mod/images/mod/28.jpg" alt="" style="height: 212.8px;"/></figure>
							<div class="content" style="height: 200px;">
								<center><h4><a id="developer_title_6" href="#">主链GitHub的源码</a></h4>
								<p id="developer_descr_6">主链GitHub的源码</p>
								</center>
							</div>
						</div>
					</div>
					
					<div id="developer_7" style="display:none" class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
						<div class="blog wow  fadeIn animated" data-wow-duration="1.3s" style="visibility: visible; animation-duration: 1.3s; animation-name: fadeIn;">
							<figure><img id="developer_img_7" src="${APP_PATH}/static/mod/images/mod/28.jpg" alt="" style="height: 212.8px;"/></figure>
							<div class="content" style="height: 200px;">
								<center><h4><a id="developer_title_7" href="#">主链GitHub的源码</a></h4>
								<p id="developer_descr_7">主链GitHub的源码</p>
								</center>
							</div>
						</div>
					</div>
...
function developer(cn){
	$.ajax({
		url:"${APP_PATH}/developers/"+cn,
		type:"GET",
		success:function(result) {	
				$.each(result.extend.developers,function(index,item){
					var i=index+1;
					$("#developer_"+i).css("display","");
					$("#developer_img_"+i).attr("src",item.img);
					$("#developer_title_"+i).text(item.title);
					$("#developer_descr_"+i).text(item.descr);
					$("#developer_title_"+i).attr("href",item.address);
					$("#developer_title_"+i).attr("target","_blank");
