	...
	<!-- 核心团队 -->	
			<div class="mobile_team">
				<div class="wid-1200" >
					...
					<p> &nbsp;</p>
					<p>WDC发起机构为新加坡WDC基金会，在曼谷设有运营中心，并以社区自治的方式运行，全球社区已形成了对wdc价值生态体系的广泛共识。现阶段与各大实体应用建立了链上应用的合作方，如电商、医疗、农产品追溯、广告等。</p>
					<p> &nbsp;</p>
					<p>WDC公链本着以服务实体经济为理念，切合大众商业需求应运而生，将在未来为区块链的事业贡献一份力量！</p>
	...
	function product(cn){
				$.ajax({
					...
					success:function(result) {
						...
						var a_2=$("<a>详情</a>").attr("href",item.address).css("margin-top","80px");
