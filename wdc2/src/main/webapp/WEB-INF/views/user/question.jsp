				...
				<div class="wid-1200">
					<div class="fag_dapp">
						<div class="dapp_items">
							<div class="dapp_item active" id="que1"><span onclick="to_page(1)">全部</span></div>
							<div class="dapp_item" id="que2"><span onclick="go2('')">技术问题</span></div>
							<div class="dapp_item" id="que3"><span onclick="go3('')">常见问题</span></div>
							<div class="dapp_item" id="que5"><span onclick="go5('')">关于我们</span></div>
							
						</div>
					</div>
					<div class="wdc-item-container" id="question1">
					
						<div class="wdc_item_text">
			...
			$.ajax({
				...
				success:function(result) {
					...
					$.each(result.extend.pageInfo.list,function(index,item){
						...
						var div2=$("<div></div>").addClass("wdc_item_bread").append("<span>"+item.author+"  / 发表于</span> ").append("<span>"+item.time+"</span>");
...
//分页查询 cn changjian
		...
		function go1(tt){
			...
			window.location.href="${pageContext.servletContext.contextPath}/user/questionDetail/?id="+ttt ;
		}
//cn 分页条信息
...
//问题模糊查询
	...
	function go5(){					
		$("#question1").empty();			
						var div0=$("<div> <p>地址：152 BEACH ROAD #14-02 GATEWAY EAST SINGAPORE (189721)</p>  <p>邮箱：wise_cc@outlook.com</p> <p>企业邮箱：market@wdc852.com</p></div>")
						div0.appendTo("#question1");
