	  ...
	  <div class="modal-dialog" role="document">
	    <div class="modal-content">
	      <div class="modal-header" enctype="multipart/form-data">
	        ...
	        <h4 class="modal-title">项目概述修改</h4>
	      </div>
	      <div class="modal-body">
	        <form class="form-horizontal" enctype="multipart/form-data" id="myForm2" >
			  ...
			  <div class="form-group">
			    ...
			    <div class="col-sm-10">
			      <input type="file" name="projectFile"  class="form-control" id="projectFile_add_input">
			  ...
			  <div class="form-group">
		    		...
		    		<div class="col-sm-10">
		      		<input type="text" name="title" class="form-control" id="title_project" >
		    	</div>
		  	</div>
		  	<div class="form-group">
		   		 <label class="col-sm-2 control-label">描述</label>
		   			 <div class="col-sm-10">
		   		   <textarea class="form-control" rows="3" name="descr" id="descr_project"></textarea>  
		    	</div>
		  	</div>
			...
			<div class="form-group" style="display: none">
		    		...
		    		<div class="col-sm-10">
		      		<input type="text" name="address" class="form-control" id="address_project" >
		    	</div>
		  	</div>
	  ...
	  <div class="modal-dialog" role="document">
	    <div class="modal-content">
	      <div class="modal-header">
	        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
	        <h4 class="modal-title" id="myModalLabel">项目概述添加</h4>
	      </div>
	      <div class="modal-body">
	      ...
	      <div class="modal-footer">
	        <button type="button" class="btn btn-default" data-dismiss="modal">关闭</button>
	        <button type="button" class="btn btn-primary" id="project_save_btn">提交</button>
	      </div>
	    </div>
	  </div>
	</div>
...
//编辑按钮、弹出模态框
		$(document).on("click",".edit_btn",function(){
			//alert("edit");
			//2、查出当前数据信息
			reset_form("#projectUpdateModal form");
...
//单查询 函数
		function getEmp(id){
			$.ajax({
				url:"${APP_PATH}/project/"+id,
				type:'GET',
				success:function(result){
					//console.log(result);
					
					var empData = result.extend.project;
					$("#projectName_update_static").text(empData.id);
					$("#title_project").val(empData.title);
					$("#descr_project").text(empData.descr);
					$("#address_project").val(empData.address);
...
//更新按钮
		$("#project_update_btn").click(function(){
			...
			//2、发送ajax请求
			$.ajax({
				url:"${APP_PATH}/project2/"+$(this).attr("edit-id"),
				type:'post',
				data:formData2,
				contentType:false,
				processData:false,
...
//批量删除
		$("#project_delete_all_btn").click(function(){
			...
			if(confirm("确认删除【"+empNames+"】吗？")){
				//发送ajax请求删除
				$.ajax({
					url:"${APP_PATH}/project/"+del_idstr,
					type:"DELETE",
					success:function(result){
						alert(result.msg);
						//回到当前页面
